---
title: "GSEA on activated samples of (future) persistent vs resolved subjects at baseline timepoint - allergy gene set"
...
write.csv(as.data.frame(res_symb), 
         file="..\\..\\data\\results\\differential_gene_expression\\activ_pers_vs_resolved_baseline_genomewide_gene_symb.csv")
...
```{r}
# fgseaSimple
# fgseaRes <- fgsea(pathways=pathways.allergy, stats=ranks, nperm=1000)
```
